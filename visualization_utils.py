...
ROI_POSITION = 200 #initially 200
...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  print('bottom_value of an object& ROI=', bottom, ROI_POSITION)
  ...
  print(predicted_direction, is_vehicle_detected)
  import time
  #time.sleep(1)
  try:
...
def visualize_boxes_and_labels_on_image_array(current_frame_number,image,
  ...
  for box, color in box_to_color_map.items():
    ...
    if (("car" in display_str_list[0]) or ("truck" in display_str_list[0]) or ("bus" in display_str_list[0]) or ("motorcycle" in display_str_list[0])):
